...
public class CircularDoublyLL<T extends Comparable<T>>{
...
//        prevNode.next.next.setPrev(node);
//        prevNode.setNext(node); //setting the next node of the previous node to the new node
//        node.setNext(prevNode.next.next); // setting the node at the specific index as the next one to the new node
